...
class GeneratorTask(threading.Thread):
    def __init__(self, q, dbhost, dbport, dbuser, dbpwd, db):
        self.task_queue = q
        self.dbhost = dbhost
        self.dbport = dbport
        self.dbuser = dbuser
...
class DuGet(threading.Thread):
    ...
    def get_detail(self, productId, api_key='70f71280d5d547b2a7bb370a529aeea1'):
        ...
        try:
            ...
            logger.error("{} {} {}".format(url, productId, e))
        return ''
...
class MailNotify(object):
    ...
    def Send(send_list):
        ...
        send_str_list = []
        for it in send_list:
            send_str_list.append("name:{},saleDiscount:{},price:{},marketPrice:{},extern:{},title:{},detail:{},\nsmallImage:{}".format(
                it['name'],it['saleDiscount'],it['price'],it['marketPrice'],it['extern'],it['title'],it['detail'],it['smallImage']
            ))
        contents = '\n\n'.join(send_str_list)
...
class VipGet(BaseGet):
    ...
    def get_product_ids(self, product_type):
        ...
        for i in range(1, 20):
            ...
            try:
                res = self.get(url, headers=self.headers, params=params)
    ...
    def get_products(self, product_type):
        ...
        for i_index in range(100):
            ...
            res = self.get(url, params=params, headers=self.headers, cookies=cookies)
            datas = res.text
