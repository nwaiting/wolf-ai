...
class NikeGet(BaseGet):
    def __init__(self, pro_dict, dbhost, dbport, dbuser, dbpwd, db):
        self.products_dict = pro_dict
        super(NikeGet, self).__init__(dbhost, dbport, dbuser, dbpwd, db)

    def get_details_page(self, uri):
        uri.replace('{countryLang}', '')
        return 'https://www.nike.com/cn/' + uri
...
if __name__ == '__main__':
    ...
    print(res.text.find('22F56116864B38EE7D93CA030645F80F'))
